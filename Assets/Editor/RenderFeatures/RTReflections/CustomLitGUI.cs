        ...
        public static class Styles
        {
            ...
            public static GUIContent reflectionsText =
                EditorGUIUtility.TrTextContent("Environment Reflections",
                    "When enabled, the Material samples reflections from the nearest Reflection Probes, Lighting Probe or uses Raytracing.");

            public static GUIContent environmentReflectionModeText = EditorGUIUtility.TrTextContent("Environment Reflection Mode",
    "Select the rendering method for environmental reflections.");

            public static GUIContent reflectionRayMultiplierText = EditorGUIUtility.TrTextContent("Ray Count Multiplier",
"Multiplicator for the number of reflection rays for this material.");
        ...
        public struct LitProperties
        {
            ...
            public MaterialProperty environmentReflectionMode;
            public MaterialProperty reflectionRayMultiplier;
            ...
            public LitProperties(MaterialProperty[] properties)
            {
                ...
                environmentReflectionMode = BaseShaderGUI.FindProperty("_EnvironmentReflectionMode", properties, false);
                reflectionRayMultiplier = BaseShaderGUI.FindProperty("_NumReflRayMult", properties, false);
        ...
        public static void SetMaterialKeywords(Material material)
        {
            ...
            if (material.HasProperty("_EnvironmentReflectionMode"))
            {
                EnvironmentReflectionMode envReflMode = (EnvironmentReflectionMode)material.GetFloat("_EnvironmentReflectionMode");
                switch (envReflMode)
                {
                    case EnvironmentReflectionMode.None:
                        CoreUtils.SetKeyword(material, "_ENVIRONMENTREFLECTIONS_OFF", true);
                        CoreUtils.SetKeyword(material, "_RT_REFLECTIONS", false);
                        break;
                    case EnvironmentReflectionMode.Unity_Default:
                        CoreUtils.SetKeyword(material, "_ENVIRONMENTREFLECTIONS_OFF", false);
                        CoreUtils.SetKeyword(material, "_RT_REFLECTIONS", false);
                        break;
                    case EnvironmentReflectionMode.Raytraced:
                        CoreUtils.SetKeyword(material, "_ENVIRONMENTREFLECTIONS_OFF", true);
                        CoreUtils.SetKeyword(material, "_RT_REFLECTIONS", true);
                        break;
                }
            }
